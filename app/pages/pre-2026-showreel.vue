<template>
  <main class="playlist">
    <LiteYouTubeEmbed id="HZjGgzxKtq0" title="Can You See My Screen? | Pilot | Vlog Diary | Showreel | Creative Development" />
  </main>
</template>
...
const projName = ref(`Showreel (Can you See My Screen)`);
const projDesc = ref(`What would Goody do?`);
